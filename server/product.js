...
app.get('/api/product-info/:id', function(req, res) {
...
app.post("/api/update-product/:id", function(req, res) {
  let product = {};
...
app.post("/api/delete-product/:id", function(req, res) {
...
app.post("/api/create-sku", function(req, res) {
  let sku = {
...
app.post("/api/update-sku/:id", function(req, res) {
  let sku = {
    price: req.body.price
  };
...
app.post("/api/delete-sku/:id", function(req, res) {
  stripe.skus.del(req.params.id, function(err, confirmation) {
    err ? res.status(500).send(err) : res.json({ success: true });
  });
});

app.post("/api/delete-collection/:id", function(req, res) {
